                ...
                <div class="navLeft">
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('showCart')}}"> <i class="fas fa-link"></i> Giỏ
                                    Hàng</a>
                            </li>
                    ...
                    <div class="nav-responsive">
                        <div class="heading-part">
                            ...
                            <ul id="myDIV" class="list-group list-group-flush ">
                                ...
                                <button class="btn">
                                        <a target="_top" class="listCategoryDetail"
                                           href="{{ route('getProductByCategory', $category->id)}}">
                                            {{$category->name}}
                                        </a>
                            ...
                            <div class="col-md-4  ">
                                <div class="product-grid listProduct">
                                    <div class="product-image ">
                                        ...
                                        <img class="pic-1" src="{{url('/images/'.$product->image)}}">
                                        <div class="productname "><span style="color: black ;font-weight: normal"> Name : </span>{{ $product->name }}
                                        </div>
                                        Price :<span class="price">{{ number_format($product->price) }} VNĐ</span>

                                        <div>
                                            <form action="{{route('detailProduct',$product->id )}}" method="post"
                                                ...
                                                <ul class="social">
                                                    <li><a href="{{route('detailProduct',$product->id)}}"
